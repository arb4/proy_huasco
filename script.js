...
var style11 = {
   ...
   /* var nod_antofa = L.geoJSON(nod_antofa, {
	...
	var cont_huasco= L.geoJSON(cont_huasco, {
	style: style1,
    onEachFeature: function (feature, layer) {
...
var proy_buenretiro_a;  
	...
	proy_buenretiro_a = L.imageOverlay('https://raw.githubusercontent.com/arb4/IMG2/main/PROY_AVHUASCOB.PNG', [[-28.573734,-70.787538],[-28.578648,-70.781824]],{opacity:0.9}).addTo(map);
